...
- [LoRA Adapter Weight Merging and Visualization (Example CTF)](#lora-adapter-weight-merging-and-visualization-example-ctf)
...
## LoRA Adapter Weight Merging and Visualization (Example CTF)
...
- Example CTF "Hefty Secrets": LoRA adapter weight merging and bitmap visualization

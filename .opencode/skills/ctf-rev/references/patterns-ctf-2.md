...
- [GLSL Shader VM with Self-Modifying Code (Example CTF)](#glsl-shader-vm-with-self-modifying-code-example-ctf)
- [GF(2^8) Gaussian Elimination for Flag Recovery (Example CTF)](#gf28-gaussian-elimination-for-flag-recovery-example-ctf)
...
## GLSL Shader VM with Self-Modifying Code (Example CTF)
...
## GF(2^8) Gaussian Elimination for Flag Recovery (Example CTF)
